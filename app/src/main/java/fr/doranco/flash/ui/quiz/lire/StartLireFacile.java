...
public class StartLireFacile extends AppCompatActivity {
    private int points;
    private TextView quizLire_tvResult, lire_tvPoints;
    private ImageView iv_lireFacile_showImage;
    private Button lireFacile_btn1, lireFacile_btn2, lireFacile_btn3, lireFacile_btn4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityLireFacileBinding binding = ActivityLireFacileBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        quizLire_tvResult = binding.quizLireTvResult;
        lire_tvPoints = binding.lireTvPoints;
        iv_lireFacile_showImage = binding.ivLireFacileShowImage;
        lireFacile_btn1 = binding.lireFacileBtn1;
        lireFacile_btn2 = binding.lireFacileBtn2;
        lireFacile_btn3 = binding.lireFacileBtn3;
        lireFacile_btn4 = binding.lireFacileBtn4;
    ...
    private void generateQuestions(int index) {
        ...
        lireFacile_btn1.setText(newList.get(0));
        lireFacile_btn2.setText(newList.get(1));
        lireFacile_btn3.setText(newList.get(2));
        lireFacile_btn4.setText(newList.get(3));
        // Aussi, appliquer ImageView à l'image actuelle de la map
        iv_lireFacile_showImage.setImageResource(map.get(letterList.get(index)));
    }

    /**
     * Methode qui s'applique lorsque le bouton Next est appuyé.
     *
     * @param view change de couleur et de visibilité.
     */
    public void nextQuestion(View view) {
        lireFacile_btn1.setBackgroundColor(Color.parseColor("#341000"));
        lireFacile_btn2.setBackgroundColor(Color.parseColor("#341000"));
        lireFacile_btn3.setBackgroundColor(Color.parseColor("#341000"));
        lireFacile_btn4.setBackgroundColor(Color.parseColor("#341000"));
        // Activer les bouttons
        lireFacile_btn1.setEnabled(true);
        lireFacile_btn2.setEnabled(true);
        lireFacile_btn3.setEnabled(true);
        lireFacile_btn4.setEnabled(true);

        index++;
        // vérifier si toutes les questions ont été posées
        if (index > 6) {
            // If true, cacher le ImageView et les Bouttons.
            iv_lireFacile_showImage.setVisibility(View.GONE);
            lireFacile_btn1.setVisibility(View.GONE);
            lireFacile_btn2.setVisibility(View.GONE);
            lireFacile_btn3.setVisibility(View.GONE);
            lireFacile_btn4.setVisibility(View.GONE);
            // Aller à l'écran GameOver avec les points
            Intent intent = new Intent(StartLireFacile.this, GameOverLireFacile.class);
    ...
    public void answerSelected(View view) {
        ...
        lireFacile_btn1.setEnabled(false);
        lireFacile_btn2.setEnabled(false);
        lireFacile_btn3.setEnabled(false);
        lireFacile_btn4.setEnabled(false);
        ...
        if (answer.equals(correctAnswer)) {
            ...
            lire_tvPoints.setText(points + " / " + letterList.size());
