...
public class StartLireNormal extends StartLireBaseActivity {
    private static final long TIMER_DURATION = 10000; // Durée du timer en millisecondes

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        // Initialiser le timer à la durée spécifiée
        ...
        countDownTimer = new CountDownTimer(millisUntilFinished, 1000) {
            ...
            public void onFinish() {
                ...
                if (index > 6) {
                    ...
                    Intent intent = new Intent(StartLireNormal.this, GameOverLireActivity.class);
